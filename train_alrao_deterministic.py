...
def main(args):
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if acc_v > best_acc:
            ...
            color = COLORS['red']
        print("EPOCH {} (in {:.2f} s)| TRAIN acc_averaged_model={:.4f} | {}VALID acc_averaged_model={:.5f}{}".format(
            epoch, end_epoch-start_epoch, list_acc_train[-1], color[0], list_acc_val[-1], color[1]))
